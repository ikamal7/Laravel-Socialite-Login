<x-guest-layout>
    ...
    <div class="flex items-center align-middle content-center justify-center">
        ...
        <a href="{{ route('google.login') }}">
            <svg class="fill-current w-5 h-5 mr-2" viewBox="0 0 533.5 544.3" xmlns="http://www.w3.org/2000/svg">
